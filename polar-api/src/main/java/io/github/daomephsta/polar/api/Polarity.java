...
{	
	...
	public static Polarity ofStack(ItemStack stack)
	{
		...
		if (stack.hasTag() && stack.getTag().containsKey(CommonWords.POLARITY))
			return Enum.valueOf(Polarity.class, stack.getTag().getString(CommonWords.POLARITY));
	...
	public static boolean isStackPolarised(ItemStack stack)
	{
		...
		return stack.getTag().containsKey(CommonWords.POLARITY);
	}
